...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	geminiEGatewayService := service.NewGeminiEGatewayService(httpUpstream, rateLimitService)
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, usageCache, identityCache, tlsFingerprintProfileService)
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, antigravityGatewayService, geminiEGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService)
	...
	grokGatewayService := service.NewGrokGatewayService(httpUpstream, rateLimitService)
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, grokGatewayService, geminiEGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, userMessageQueueService, configConfig, settingService)
