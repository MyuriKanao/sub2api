...
const form = reactive({ email: '', password: '', username: '', notes: '', role: 'user' as 'admin' | 'user', balance: 0, concurrency: 1 })
...
watch(() => props.show, (v) => { if(v) Object.assign(form, { email: '', password: '', username: '', notes: '', role: 'user', balance: 0, concurrency: 1 }) })
